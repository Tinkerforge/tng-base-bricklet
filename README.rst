...
This Bricklet is internal to the TNG system. It is used with a different
non-TNG bus, so it can be a used as a watchdog for the TNG bus.

We use the Bricklet libs and protocol because it is well tested and
supported. The API of this Bricklet is not exposed to users, it stays
internal to the TNG base.
